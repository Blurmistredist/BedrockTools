        ...
        for (auto& [k, v] : j.items()) {
            ...
            if (v.is_boolean()) {
                ...
                if (kLower.find("opacity") != std::string::npos ||
                    ...
                    maxVal = 1.0f;
                } else if (kLower.find("fadestart") != std::string::npos ||
                           kLower.find("fadeend") != std::string::npos) {
                    minVal = -300.0f;
                    maxVal = 300.0f;
                    ...
                    minVal = -3.0f;
                    maxVal = 3.0f;
                } else if (kLower.find("smoothness") != std::string::npos) {
                    minVal = 0.5f;
                    maxVal = 30.0f;
                } else if (kLower.find("crosshairsize") != std::string::npos) {
                    minVal = 2.0f;
                    maxVal = 30.0f;
                } else if (kLower.find("crosshairthickness") != std::string::npos) {
                    minVal = 0.5f;
                    maxVal = 8.0f;
                } else if (kLower.find("historyseconds") != std::string::npos) {
                    minVal = 1.0f;
                    maxVal = 10.0f;
